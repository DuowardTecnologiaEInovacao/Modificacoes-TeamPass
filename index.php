    ...
    && empty($get['otv']) === false)
{
    ...
    <img src="includes/img/custom/Logo-SentinelArk.png" alt="Sentinel Logo" class="brand-image" style="opacity: .8; border-radius: .25rem;">
...
?>
            ...
            <footer class="main-footer">
                ...
                <!-- Default to the left -->
                <strong>Desenvolvido por Teampass customizado por Duoward</strong> 
            </footer>
        </div>
        <!-- ./wrapper -->
